...
class HashingCommands:
    ...
    def register_HashingCommands(self):
        @self.tree.command(name="md5", description="Get the MD5 hash for a string", guild=SERVER_OBJ)
        ...
        @self.tree.command(name="sha1", description="Get the SHA1 hash for a string", guild=SERVER_OBJ)
        ...
        @self.tree.command(name="sha256", description="Get the SHA256 hash for a string", guild=SERVER_OBJ)
        ...
        @self.tree.command(name="sha512", description="Get the SHA512 hash for a string", guild=SERVER_OBJ)
