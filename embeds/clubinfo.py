...
clubinfo.set_footer(
    text="BlueBot | Made by CS2A Bot Developers", icon_url=cs2a_logo_url)
clubinfo.set_thumbnail(url=cs2a_logo_url)
clubinfo.add_field(name="Server Invite", value="https://discord.gg/aGG4Zjt")
clubinfo.add_field(name="Join the CS2A Campus Groups",
                   value="https://odu.campusgroups.com/cs2a/club_signup")
