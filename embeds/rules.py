...
rules.set_footer(text="BlueBot | Made by CS2A Bot Developers",
                 icon_url=cs2a_logo_url)
rules.set_thumbnail(url=cs2a_logo_url)
rules.add_field(name=":one: Be Respectful",
                value="You must respect all users regardless of your liking towards them. We encourage constructive discourse.")
rules.add_field(name=":two: Tolerance",
                value="No homophobia, racism, sexism, slurs, or discrimination/bias of any from.")
rules.add_field(name=":three: Do not Spam",
                value="Do not send a lot of small messages right after each other. Do not disrupt chat by spamming.")
rules.add_field(name=":four: No NSFW Material",
                value="This is a community server, not the place for that type of content.")
...
rules.add_field(name=":six: Direct and Indirect Threats",
                value="Threats against other users (Death, DDoS, DoX, abuse, and malicious threats) will not be tolerated.")
rules.add_field(name=":seven: Follow the Discord Community Guidelines",
                value="You can find those here https://discord.com/guidelines.")
