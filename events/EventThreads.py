import discord
from variables.variables import events_channel, debug
...
class EventThreads:
    ...
    def register_EventThreads(self):
        ...
        async def on_raw_reaction_add(payload: discord.RawReactionActionEvent):
            ...
            message = await self.client.get_channel(events_channel).fetch_message(payload.message_id)
            event_name = message.content
            threads = self.client.get_channel(events_channel).threads
        ...
        async def on_scheduled_event_create(event: discord.ScheduledEvent):
            ...
            channel = self.client.get_channel(events_channel)
